...
export const deepDive: DeepDive = {
  ...
  sections: [
    ...
    },
    {
      ...
      example: {
        ...
        body: 'A field experiment with low-income workers in India found that cash physically partitioned and earmarked in sealed envelopes produced higher savings than the same cash handed over unpartitioned — and that the effect strengthened when the envelope carried a photograph of the saver’s children. A separate field experiment in Germany found that people did not treat category-labelled vouchers as interchangeable with cash, spending more in the labelled category than fungibility predicts; a companion laboratory experiment in the same paper found the violation concentrated among subjects with weaker numeracy. In one setting the violation of fungibility raised people’s savings; in the other it pulled their spending away from what they would otherwise have chosen. Same mechanism, opposite verdicts.',
      },
    },
    {
      ...
      body: [
        ...
        'The same logic produces the topical account, where a saving is judged against the price of the item it attaches to rather than against your finances. A five-dollar saving on a fifteen-dollar calculator is worth a twenty-minute drive to about two-thirds of people; the identical five dollars off a calculator costing a hundred and twenty-five is worth that same drive to under a third. And Thaler and Eric Johnson documented the house-money effect: after a gain, people take risks with the winnings they would refuse with money coded as their own stake.',
      ],
    },
    {
  ...
  evidence: [
    ...
    {
      source: 'Soman & Cheema, earmarking and partitioning field experiment (Journal of Marketing Research, 2011); Abeler & Marklein, labelled-voucher field experiment and companion lab experiment (2017)',
      finding: 'Cash earmarked and physically partitioned in sealed envelopes raised savings among low-income households, more so when the envelope carried a photograph of the saver’s children. Separately, a field experiment found people did not treat labelled vouchers as interchangeable with cash; a companion lab experiment in the same paper found the violation concentrated among subjects with weaker numeracy.',
      caveat: 'Individual field experiments in specific populations, and the numeracy result specifically comes from the voucher paper’s companion lab experiment. The direction is consistent with the framework; the magnitudes should not be transported to other settings.',
    },
    {
