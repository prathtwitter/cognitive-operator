...
export const deepDive: DeepDive = {
  ...
  sections: [
    {
      ...
      body: [
        ...
        'Morton Deutsch and Harold Gerard drew the necessary distinction in 1955. Normative influence is going along with a group because of what the group will think of you. Informational influence is treating other people’s behaviour as evidence about the world. Asch’s line-judgement studies are usually filed under normative influence, and much of the yielding was: people who knew better and complied. Asch’s own categorisation is messier, though — his largest group of yielders concluded that their own judgement must be the faulty one, which is informational influence doing the work. A cascade is the clean case, because it runs among anonymous strangers who will never meet, have no reputation at stake, and are trying only to be right. Strip out every social consequence and the herding still happens.',
  ...
  commonMisreads: [
    ...
    },
    {
      ...
      correction: 'Different mechanisms, different cures. Asch’s situation mixes both — some yielders knew better and complied, while more of them decided their own judgement must be wrong. A cascade needs no social pressure at all and runs among anonymous strangers trying only to be accurate. Fixing the social dynamics of a room does not stop a cascade; fixing the sequence and the format does.',
    },
    {
