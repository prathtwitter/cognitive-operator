...
export const deepDive: DeepDive = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        'The natural defence is that this describes the public, not people who work with numbers. Slovic\'s finding is that experts\' risk judgements track technical fatality estimates far more closely than lay judgements do — inside their domain. His further point is the one that matters here: when experts are pushed beyond the limits of their data, they fall back on the same affective machinery as everyone else. Experts hold well-tuned tags inside their domain, which is exactly why their intuitions are good there — and no tags outside it, which is where confidence outruns calibration.',
