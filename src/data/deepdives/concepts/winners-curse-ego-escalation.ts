...
export const deepDive: DeepDive = {
  ...
  evidence: [
    ...
    {
      source: 'Bazerman & Samuelson, “I Won the Auction But Don’t Want the Prize” (1983); Samuelson & Bazerman, “The Winner’s Curse in Bilateral Negotiations” (1985)',
      finding: 'The 1983 paper auctioned jars holding $8 in coins: the average bid fell below the true value while the average winning bid exceeded it, so the seller profited and the winner lost. The 1985 paper introduced the Acquiring a Company problem, where the correct bid is zero and most respondents bid between $50 and $75.',
    },
    {
