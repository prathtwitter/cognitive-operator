...
export const deepDive: DeepDive = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        'Default acceptance does not sort neatly by education or salary. In the large automatic-enrolment studies across three big firms, roughly four in five participants kept both the default contribution rate and the default fund, about half were still sitting at both three years later, and that acceptance ran across demographic and salary groups rather than concentrating among the least informed. Whatever is happening here, it is not simply that some people do not understand retirement saving.',
  ...
  commonMisreads: [
    ...
    },
    {
      ...
      correction: 'In the large automatic-enrolment studies, default acceptance held across demographic and salary groups rather than concentrating among the least informed. The mechanism runs on effort and inference, not on ignorance, so knowing how the system works does not by itself neutralize it.',
    },
    {
  ...
  evidence: [
    ...
    },
    {
      ...
      caveat: 'This measures registered legal consent, not organs actually transplanted. Most opt-out countries still consult next-of-kin, and actual donation rates across opt-in and opt-out countries differ far less than the consent-rate gap implies — reviews find infrastructure and coordination matter at least as much as the legal default, without settling the split (Spain, the usual success story, credits its dedicated coordinator system). Treat the headline statistic as real but considerably narrower than its popular retelling.',
    },
    {
    ...
    {
      source: 'Choi, Laibson, Madrian & Metrick, “For Better or For Worse: Default Effects and 401(k) Savings Behavior” (2004)',
      finding: 'Across three large firms, roughly 80% of automatically enrolled participants accepted both the default contribution rate and the default fund, and about half were still at both three years later. Acceptance was high across demographic and salary groups rather than confined to low-information employees.',
    },
  ],
  takeaways: [
    ...
    'Expertise does not neutralize default effects. In the large automatic-enrolment studies, acceptance ran across demographic and salary groups rather than concentrating among the least informed.',
